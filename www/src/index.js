...
var renderTiles = function renderTiles(gameboy) {
  ...
  // drawTiles(tiles[0], 0, 0);
  // drawTiles(tiles[0], 8*PIXEL_SIZE, 0);
  // drawTiles(tiles[0], 0, 8*PIXEL_SIZE);
  var x = 0;
  var y = 0;
  ...
  // drawTiles(tiles[0], 0, 0);
  // drawTiles(tiles[1], 40, 0);
  // drawTiles(tiles[2], 80, 0);
  // drawTiles(tiles[3], 120, 0);
  // drawTiles(tiles[4], 160, 0);
  // drawTiles(tiles[5], 200, 0);
  // drawTiles(tiles[6], 240, 0);
  // drawTiles(tiles[7], 280, 0);
  // drawTiles(tiles[8], 320, 0);
  // drawTiles(tiles[9], 360, 0);
  // drawTiles(tiles[10], 400, 0);
  // drawTiles(tiles[11], 440, 0);
  // drawTiles(tiles[12], 480, 0);
  // drawTiles(tiles[25], 520, 0);

  // drawTiles(tiles[13], 0, 40);
  // drawTiles(tiles[14], 80, 0);
  // drawTiles(tiles[15], 120, 0);
  // drawTiles(tiles[16], 160, 0);
  // drawTiles(tiles[17], 200, 0);
  // drawTiles(tiles[18], 240, 0);
  // drawTiles(tiles[19], 280, 0);
  // drawTiles(tiles[20], 320, 0);
  // drawTiles(tiles[21], 360, 0);
  // drawTiles(tiles[22], 400, 0);
  // drawTiles(tiles[23], 440, 0);
  // drawTiles(tiles[24], 480, 0);
  // counter = counter+1;
  // console.log(">>>>>>>>>>>>>counter");
  // console.log(counter);
  // if (counter < 5){
...
var renderBackground1 = function renderBackground1(gameboy) {
  var pixelsPtr = gameboy.pixels();
  var pixels = new Uint8Array(memory.buffer, pixelsPtr, width * height);
  var tiles = [];
  var sliceIdx = 0;
  ...
  const gameboyBackground1 = gameboy.background1();
  const gameboyBackground1Idxes = [
    0,
    0,
    0,
    0,
  ...
  //   width * height
  // );
  //  console.log(gameboyBackground1Idxes.toString());
  gameboyBackground1Idxes.forEach(function(ele, idx) {
    drawTiles(tiles[ele], x, y);
    if (ele > 0) {
      console.log("ele, idx, x, y");
      console.log(ele, idx, x, y);
    }
    x = x + 8 * PIXEL_SIZE;
    if (x >= canvas.width) {
  ...
  // drawTiles(tiles[13], 40, 40);
  // drawTiles(tiles[14], 80, 40);
  // drawTiles(tiles[15], 120, 40);
  // drawTiles(tiles[16], 160, 40);
  // drawTiles(tiles[17], 200, 40);
  // drawTiles(tiles[18], 240, 40);
  // drawTiles(tiles[19], 280, 40);
  // drawTiles(tiles[20], 320, 40);
  // drawTiles(tiles[21], 360, 40);
  // drawTiles(tiles[22], 400, 40);
  // drawTiles(tiles[23], 440, 40);
  // drawTiles(tiles[24], 480, 40);
  // console.log("safe")
...
var render = function render(gameboy, memoryBytes) {
  ...
  ReactDOM.render(
    React.createElement(Debugger, {
      ...
      opLog: opLog,
      registers: registers,
      onDraw: () => renderTiles(gameboy),
      onDrawBackground: () => renderBackground1(gameboy)
    }),
    domContainer
  );
